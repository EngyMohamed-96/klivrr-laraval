{{-- Header Mobile --}}
<div id="kt_header_mobile" class="header-mobile {{ Mimocodes::printClasses('header-mobile', false) }}" {{ Mimocodes::printAttrs('header-mobile') }}>
    ...
    <div class="d-flex align-items-center">
        ...
        <button class="btn btn-hover-text-primary p-0 ml-2" id="kt_header_mobile_topbar_toggle">
            {{ Mimocodes::getSVG('media/svg/icons/General/User.svg', 'svg-icon-xl') }}
        </button>
