        ...
        <div class="scroll pr-7 mr-n7" data-scroll="true" data-height="300" data-mobile-height="200">
            ...
            <div class="d-flex align-items-center mb-6">
                ...
                <div class="symbol symbol-40 symbol-light-primary mr-5">
                    <span class="symbol-label">
                        {{ Mimocodes::getSVG("media/svg/icons/Home/Library.svg", "svg-icon-lg svg-icon-primary") }}
                    </span>
                </div>
            ...
            <div class="d-flex align-items-center mb-6">
                ...
                <div class="symbol symbol-40 symbol-light-warning mr-5">
                    <span class="symbol-label">
                        {{ Mimocodes::getSVG("media/svg/icons/Communication/Write.svg", "svg-icon-lg svg-icon-warning") }}
                    </span>
                </div>
            ...
            <div class="d-flex align-items-center mb-6">
                ...
                <div class="symbol symbol-40 symbol-light-success mr-5">
                    <span class="symbol-label">
                        {{ Mimocodes::getSVG("media/svg/icons/Communication/Group-chat.svg", "svg-icon-lg svg-icon-success") }}
                    </span>
                </div>
            ...
            <div class="d-flex align-items-center mb-6">
                ...
                <div class="symbol symbol-40 symbol-light-danger mr-5">
                    <span class="symbol-label">
                        {{ Mimocodes::getSVG("media/svg/icons/General/Attachment2.svg", "svg-icon-lg svg-icon-danger") }}
                    </span>
                </div>
            ...
            <div class="d-flex align-items-center mb-2">
                ...
                <div class="symbol symbol-40 symbol-light-info mr-5">
                    <span class="symbol-label">
                        {{ Mimocodes::getSVG("media/svg/icons/Communication/Shield-user.svg", "svg-icon-lg  svg-icon-info") }}
                    </span>
                </div>
            ...
            <div class="d-flex align-items-center mb-2">
                ...
                <div class="symbol symbol-40 symbol-light-info mr-5">
                    <span class="symbol-label">
                        {{ Mimocodes::getSVG("media/svg/icons/Communication/Mail-notification.svg", "svg-icon-lg  svg-icon-info") }}
                    </span>
                </div>
            ...
            <div class="d-flex align-items-center mb-2">
                ...
                <div class="symbol symbol-40 symbol-light-info mr-5">
                    <span class="symbol-label">
                        {{ Mimocodes::getSVG("media/svg/icons/Design/Bucket.svg", "svg-icon-lg  svg-icon-info") }}
                    </span>
                </div>
