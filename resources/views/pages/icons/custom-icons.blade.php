...
@section('content')
    ...
    <div class="alert alert-custom alert-white alert-shadow fade show gutter-b" role="alert">
        ...
        <div class="alert-text">
            MIMOCODES Custom Icon set provides a large set of web font icons with line, solid, bold styles.
        </div>
    </div>
    <!--end::Notice-->
        ...
        <div class="col-xl-6">
            ...
            <div class="card card-custom gutter-b card-stretch">
                ...
                <div class="card-body">
                    ...
                    <div>
                        <p>
                            <code>MIMOCODES Icons</code> icons can be used as through class names as shown below.
                        </p>
        ...
        <div class="col-xl-6">
            ...
            <div class="card card-custom gutter-b card-stretch">
                ...
                <div class="card-body">
                    ...
                    <div>
                        <p>
                            You can use MIMOCODES Icons literally with any element within Metronic.
                        </p>
                        <div class="example-preview">
