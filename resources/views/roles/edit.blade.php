        ...
        <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center flex-wrap mr-2">
                    <!--begin::Title-->
                    <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">{{ __('dashboard.edit_role') }}</h5>
                    <!--end::Title-->
                    <!--begin::Separator-->
                                    ...
                                    <div class="wizard-step" data-wizard-type="step" data-wizard-state="current">
                                        <div class="wizard-wrapper">
                                            ...
                                            <div class="wizard-label">
                                                ...
                                                <div class="wizard-desc">{{__('dashboard.edit_role')}}</div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="card-body p-0">
                            <div class="row justify-content-center py-8 px-8 py-lg-15 px-lg-10">
                                <div class="col-xl-12 col-xxl-10">
                                    <!--begin::Wizard Form-->
                                    <form method="post" action="{{ route('roles.update', $role) }}" autocomplete="off" id="kt_form">
                                        @csrf
                                        @method('put')
                                            ...
                                            <div class="col-xl-9">
                                                ...
                                                <!--end::Group-->
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            <input class="form-control form-control-solid form-control-lg" name="name" type="text" value="{{ old('name', $role->name) }}" />
                                                        </div>
                                                    </div>
                                                    <!--end::Group-->
                                                    <!--begin::Group-->
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            <textarea class="form-control form-control-solid form-control-lg {{ $errors->has('description') ? ' is-invalid' : '' }} " name="description" type="text" cols="30" rows="10"  placeholder="{{ __('dashboard.Description') }}"  >{{ old('description', $role->description) }}</textarea>
{{--                                                            <textarea name="description" id="description" cols="30" rows="10" class="form-control{{ $errors->has('description') ? ' is-invalid' : '' }}" placeholder="{{ __('dashboard.Description') }}" value="{{ old('name', $role->description) }}"></textarea>--}}
