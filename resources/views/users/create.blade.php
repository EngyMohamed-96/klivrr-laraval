@extends('layout.default', [
    ...
    'parentSection' => 'manage-users',
    'elementName' => 'user-create',
])
@section('styles')
        ...
        <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center flex-wrap mr-2">
                    <!--begin::Title-->
                    <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">{{ __('dashboard.new_user') }}</h5>
                    <!--end::Title-->
                    <!--begin::Separator-->
                    ...
                    <div class="d-flex align-items-center" id="kt_subheader_search">
                        <span class="text-dark-50 font-weight-bold" id="kt_subheader_total">{{ __('dashboard.enter_user_details') }}</span>
                    </div>
                    <!--end::Search Form-->
                </div>
                <!--end::Details-->
                                ...
                                <div class="wizard-steps">
                                    <div class="wizard-step" data-wizard-type="step" data-wizard-state="current">
                                        <div class="wizard-wrapper">
                                            ...
                                            <div class="wizard-label">
                                                <div class="wizard-title">{{ __('dashboard.profile') }}</div>
                                                <div class="wizard-desc">{{ __('dashboard.user_pers_inf') }}</div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="wizard-step" data-wizard-type="step">
                                        <div class="wizard-wrapper">
                                            ...
                                            <div class="wizard-label">
                                                <div class="wizard-title">{{ __('dashboard.account') }}</div>
                                                <div class="wizard-desc">{{ __('dashboard.user_acc_sett') }}</div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="wizard-step" data-wizard-type="step">
                                        <div class="wizard-wrapper">
                                            ...
                                            <div class="wizard-label">
                                                <div class="wizard-title">{{ __('dashboard.address') }}</div>
                                                <div class="wizard-desc">{{ __('dashboard.user_adds') }}</div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="wizard-step" data-wizard-type="step">
                                        <div class="wizard-wrapper">
                                            ...
                                            <div class="wizard-label">
                                                <div class="wizard-title">{{ __('dashboard.submission') }}</div>
                                                <div class="wizard-desc">{{ __('dashboard.rev_&_sub') }}</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                <div class="row justify-content-center">
                                                    <div class="col-xl-9">
                                                        ...
                                                        <div class="my-5 step" data-wizard-type="step-content" data-wizard-state="current">
                                                            <h5 class="text-dark font-weight-bold mb-10">{{ __('dashboard.user_det') }}</h5>
                                                            <!--begin::Group-->
                                                            <div class="form-group row">
                                                                <label class="col-xl-3 col-lg-3 col-form-label text-left">{{ __('dashboard.avatar') }}</label>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-lg-9 col-xl-9">
                                                                    <input class="form-control form-control-solid form-control-lg" name="firstname" type="text" value="" placeholder="enter first name" />
                                                                </div>
                                                            </div>
                                                            <!--end::Group-->
                                                            <!--begin::Group-->
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-lg-9 col-xl-9">
                                                                    <input class="form-control form-control-solid form-control-lg" name="lastname" type="text" value="" placeholder="enter last name" />
                                                                </div>
                                                            </div>
                                                            <!--end::Group-->
                                                            <!--begin::Group-->
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-lg-9 col-xl-9">
                                                                    <div class="input-group input-group-solid input-group-lg">
                                                                        ...
                                                                        <input type="text" class="form-control form-control-solid form-control-lg" name="email" value="" placeholder="enter Email Address" />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <!--end::Group-->
                                                        ...
                                                        <div class="my-5 step" data-wizard-type="step-content">
                                                            <h5 class="text-dark font-weight-bold mb-10 mt-5">{{ __('dashboard.user_det') }}</h5>
                                                            <!--begin::Group-->
                                                            <div class="form-group row">
                                                                <label class="col-form-label col-xl-3 col-lg-3">{{ __('dashboard.language') }}</label>
                                                                <div class="col-xl-9 col-lg-9">
                                                                    <select class="form-control form-control-lg form-control-solid" name="language">
                                                                        @foreach($languages as $language => $name)
                                                                            <option value="{{ $language }}" {{ $language == old('language') ? 'selected' : '' }}>{{ $name }}</option>
                                                                        @endforeach
                                                                    </select>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <!--begin::Group-->
                                                            <div class="form-group row">
                                                                <label class="col-form-label col-xl-3 col-lg-3">{{ __('dashboard.time_zone') }}</label>
                                                                <div class="col-xl-9 col-lg-9">
                                                            ...
                                                            <!--begin::Group-->
                                                            <div class="form-group row">
                                                                <label class="col-form-label col-xl-3 col-lg-3">{{ __('dashboard.communication') }}</label>
                                                        ...
                                                        <!--begin::Wizard Step 3-->
                                                        <div class="my-5 step" data-wizard-type="step-content">
                                                            <h5 class="mb-10 font-weight-bold text-dark">{{ __('dashboard.set_add') }}</h5>
                                                            <!--begin::Group-->
                                                            <div class="form-group">
                                                                <label>{{ __('dashboard.add1') }}</label>
                                                                ...
                                                                <span class="form-text text-muted">{{ __('dashboard.pls_add') }}</span>
                                                            </div>
                                                            <!--end::Group-->
                                                            <!--begin::Group-->
                                                            <div class="form-group">
                                                                <label>{{ __('dashboard.add2') }}</label>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-xl-6">
                                                                    <!--begin::Group-->
                                                                    <div class="form-group">
                                                                        <label>{{ __('dashboard.postcode') }}</label>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-xl-6">
                                                                    <!--begin::Group-->
                                                                    <div class="form-group">
                                                                        <label>{{ __('dashboard.state') }}</label>
...
{{--                                                <h6 class="heading-small text-muted mb-4">{{ trans('dashboard.User information') }}</h6>--}}
{{--                                                <div class="pl-lg-4">--}}
{{--                                                    <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">--}}
{{--                                                        <label class="form-control-label" for="input-name">{{ trans('dashboard.Name') }}</label>--}}
{{--                                                        <input type="text" name="first_name" id="input-name" class="form-control{{ $errors->has('first_name') ? ' is-invalid' : '' }}" placeholder="{{ trans('dashboard.Name') }}" value="" required autofocus>--}}

{{--                                                    </div>--}}

{{--                                                    <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">--}}
{{--                                                        <label class="form-control-label" for="input-lastname">{{ trans('dashboard.Name') }}</label>--}}
{{--                                                        <input type="text" name="last_name" id="input-lastname" class="form-control{{ $errors->has('last_name') ? ' is-invalid' : '' }}" placeholder="{{ trans('dashboard.Name') }}" value="" required autofocus>--}}

{{--                                                    </div>--}}

{{--                                                    <div class="form-group{{ $errors->has('email') ? ' has-danger' : '' }}">--}}
{{--                                                        <label class="form-control-label" for="input-email">{{ trans('dashboard.Email') }}</label>--}}
{{--                                                        <input type="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" name="email" id="input-email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" placeholder="{{ trans('dashboard.Email') }}" value="{{ old('email') }}" required>--}}

{{--                                                    </div>--}}
{{--                                                    <div class="form-group{{ $errors->has('role_id') ? ' has-danger' : '' }}">--}}
{{--                                                        <label class="form-control-label" for="input-role">{{ trans('dashboard.Role') }}</label>--}}
{{--                                                        <select name="role_id" id="input-role" class="form-control{{ $errors->has('role_id') ? ' is-invalid' : '' }}" placeholder="{{ trans('dashboard.Role') }}" required>--}}
{{--                                                            <option value="">-</option>--}}
...
{{--                                                        @foreach ($roles as $role)--}}
{{--                                                            <p class="small"><strong>{{$role->name . ':'}}</strong> {{ $role->description }}</p>--}}
{{--                                                        @endforeach--}}
{{--                                                    </div>--}}
{{--                                                    <div class="form-group{{ $errors->has('photo') ? ' has-danger' : '' }}">--}}
{{--                                                        <label class="form-control-label" for="input-name">{{ trans('dashboard.Profile photo') }}</label>--}}
{{--                                                        <div class="custom-file">--}}
{{--                                                            <input type="file" name="photo" class="custom-file-input{{ $errors->has('photo') ? ' is-invalid' : '' }}" id="input-picture" accept="image/*">--}}
{{--                                                            <label class="custom-file-label" for="input-picture">{{ trans('dashboard.Select profile photo') }}</label>--}}
{{--                                                        </div>--}}

{{--                                                    </div>--}}

{{--                                                    <div class="form-group{{ $errors->has('company') ? ' has-danger' : '' }}">--}}
{{--                                                        <label class="form-control-label" for="input-company">{{ trans('dashboard.Company') }}</label>--}}
{{--                                                        <input type="text" name="company" id="input-company" class="form-control{{ $errors->has('company') ? ' is-invalid' : '' }}" placeholder="{{ trans('dashboard.VIG') }}" value="{{ old('company') }}" required autofocus>--}}
...
{{--                                                        <label class="form-control-label" for="input-language">{{ trans('dashboard.Language')}}</label>--}}
{{--                                                        <select name="language" id="input-language" class="form-control{{ $errors->has('language') ? ' is-invalid' : '' }}" placeholder="{{ trans('dashboard.Language') }}" required>--}}
{{--                                                            --}}{{--                                        <option value="">-</option>--}}
{{--                                                            @foreach($languages as $language => $name)--}}
{{--                                                                <option value="{{ $language }}" {{ $language == old('language') ? 'selected' : '' }}>{{ $name }}</option>--}}
{{--                                                            @endforeach--}}
...
{{--                                                        <label class="form-control-label" for="input-password">{{ trans('dashboard.Password') }}</label>--}}
{{--                                                        <input type="password" name="password" id="input-password" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" placeholder="{{ trans('dashboard.Password') }}" value="" required>--}}

{{--                                                    </div>--}}
{{--                                                    <div class="form-group">--}}
{{--                                                        <label class="form-control-label" for="input-password-confirmation">{{ trans('dashboard.Confirm Password') }}</label>--}}
{{--                                                        <input type="password" name="password_confirmation" id="input-password-confirmation" class="form-control" placeholder="{{ trans('dashboard.Confirm Password') }}" value="" required>--}}
{{--                                                    </div>--}}

{{--                                                    <div class="text-center">--}}
{{--                                                        <button type="submit" class="btn btn-success mt-4">{{ trans('dashboard.Save') }}</button>--}}
{{--                                                    </div>--}}
{{--                                                </div>--}}
{{--                                            </form>--}}
                                        </div>
