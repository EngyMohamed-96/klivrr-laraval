        ...
        <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center flex-wrap mr-2">
                    <!--begin::Title-->
                    <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">{{__('dashboard.profile')}}</h5>
                    <!--end::Title-->
                    <!--begin::Separator-->
                    ...
                    <div class="d-flex align-items-center" id="kt_subheader_search">
                        <span class="text-dark-50 font-weight-bold" id="kt_subheader_total">{{$user->first_name .' '. $user->last_name}}</span>
                    </div>
                    <!--end::Search Form-->
                </div>
                <!--end::Details-->
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="btn-group ml-2">
                        <a href="{{route('users.edit' , $user)}}" class="btn btn-primary font-weight-bold btn-sm px-3 font-size-base">{{__('dashboard.edit_profile')}}</a>
...
{{--                                                <div class="symbol-label" style="background-image:url{{$user->profilePicture()}}"></div>--}}
{{--                                                <i class="symbol-badge bg-success"></i>--}}
{{--                                            </div>--}}
{{--                                            <div>--}}
{{--                                                <a href="#" class="font-weight-bolder font-size-h5 text-dark-75 text-hover-primary">{{$user->first_name.' '.$user->last_name}}</a>--}}
{{--                                                <div class="text-muted">{{$user->account_status}}</div>--}}
{{--                                                <div class="mt-2">--}}
{{--                                                    <a href="#" class="btn btn-sm btn-primary font-weight-bold mr-2 py-2 px-3 px-xxl-5 my-1">{{__('dashboard.send_email')}}</a>--}}
{{--                                                </div>--}}
{{--                                            </div>--}}
{{--                                        </div>--}}
{{--                                        <!--end::User-->--}}
...
{{--                                                <span class="font-weight-bold mr-2">{{__('dashboard.location')}}:</span>--}}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-7 my-2">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-9">
                                                    <div class="symbol symbol-60 symbol-xxl-100 mr-5 align-self-start align-self-xxl-center">
                                                        <div class="symbol-label" style="background-image:url({{ $user->last_name }})"></div>
                                                        <i class="symbol-badge bg-success"></i>
                                                    </div>
                                                </div>
                                            </div>
...
{{--                                                    <input class="form-control form-control-lg form-control-solid" type="text" value="{{ old('name', $user->first_name) }}" />--}}
                                                    <span class="form-control form-control-lg form-control-solid">{{ old('name', $user->first_name) }}</span>
...
{{--                                                    <input class="form-control form-control-lg form-control-solid" type="text" value="{{ $user->last_name }}" />--}}
                                                    <span class="form-control form-control-lg form-control-solid">{{ $user->last_name }}</span>
...
{{--                                                                                            <input class="form-control form-control-lg form-control-solid" type="text" value="Loop Inc." />--}}
{{--                                                                                            <span class="form-text text-muted">If you want your invoices addressed to a company. Leave blank to use your full name.</span>--}}
                                                                                            <span class="form-control form-control-lg form-control-solid">{{ $user->company }}</span>
...
{{--                                                        <input type="text" class="form-control form-control-lg form-control-solid" value="{{ old('name', $user->phone) }}" placeholder="Phone" />--}}
                                                        <span class="form-control form-control-lg form-control-solid">{{ old('name', $user->phone) }}</span>
...
{{--                                                        <input type="text" class="form-control form-control-lg form-control-solid" value="{{ old('name', $user->email) }}" placeholder="Email" />--}}
                                                        <span class="form-control form-control-lg form-control-solid">{{ old('name', $user->email) }}</span>
...
{{--                                                            <input class="form-control form-control-lg form-control-solid" type="text" value="{{ old('name', $user->first_name.' '.$user->last_name) }}" />--}}
                                                            <span class="form-control form-control-lg form-control-solid">{{ old('name', $user->first_name.' '.$user->last_name) }}</span>
...
{{--                                                </div>--}}
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-9">
                                                        <div>
                                                            {{--                                                            <input class="form-control form-control-lg form-control-solid" type="text" value="{{ old('name', $user->first_name.' '.$user->last_name) }}" />--}}
                                                            <span class="form-control form-control-lg form-control-solid">{{ old('name', $user->language) }}</span>
...
{{--                                                </div>--}}
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-9">
                                                        <div>
                                                            {{--                                                            <input class="form-control form-control-lg form-control-solid" type="text" value="{{ old('name', $user->first_name.' '.$user->last_name) }}" />--}}
                                                            <span class="form-control form-control-lg form-control-solid">{{ old('name', $user->time_zone) }}</span>
...
{{--                                                <!--begin::Group-->--}}
{{--                                                <div class="form-group row">--}}
{{--                                                    <label class="col-form-label col-3 text-lg-right text-left">{{__('dashboard.current_password')}}</label>--}}
{{--                                                    <div class="col-9">--}}
